...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      role="group" // react-doctor-disable-line react-doctor/prefer-tag-over-role -- vendored shadcn: groups input + addons; no native tag fits (rule suggests <address>, wrong here)
      className={cn(
...
// react-doctor-disable-next-line react-doctor/no-multi-comp -- vendored shadcn barrel: 6-comp primitive barrel, all exported; rule's barrel exemption should cover this
function InputGroupAddon({
  ...
  return (
    // react-doctor-disable-next-line react-doctor/click-events-have-key-events -- vendored shadcn: click focuses the control; mouse-only convenience, keyboard users tab straight to the control
    <div
      role="group" // react-doctor-disable-line react-doctor/prefer-tag-over-role -- vendored shadcn: groups input + addons; no native tag fits (rule suggests <address>, wrong here)
